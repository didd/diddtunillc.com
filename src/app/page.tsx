...
const COMPANY_START_DATE = new Date("2022-07-27T00:00:00Z");

function getYearsInOperationLabel(now = new Date()) {
  let years = now.getUTCFullYear() - COMPANY_START_DATE.getUTCFullYear();
  let months = now.getUTCMonth() - COMPANY_START_DATE.getUTCMonth();
  const days = now.getUTCDate() - COMPANY_START_DATE.getUTCDate();
  ...
  return months < 6 ? `${years}` : `${years}.5+`;
}

export default function Home() {
  const yearsInOperation = getYearsInOperationLabel();
  ...
  return (
    <>
      ...
      <main id="main-content" tabIndex={-1}>
            ...
            <div className="max-w-[920px]">
              ...
              <FadeUp delay={200}>
                <div className="mt-10 max-w-[650px] border-l border-accent/35 pl-6 sm:pl-7">
                  <p className="text-[1.05rem] leading-[1.9] text-text-muted sm:text-[1.14rem]">
                    Didd Tuni LLC is a U.S.-registered software engineering
                    consultancy specializing in high-performance React &amp;
                    TypeScript applications, design systems, and full-stack
              ...
              <FadeUp delay={300}>
                <div className="mt-10 flex flex-col items-stretch gap-4 sm:flex-row sm:flex-wrap sm:items-center">
                  <a
                    href="#contact"
                    className={`${buttonVariants({ variant: "primary" })} w-full justify-center sm:min-w-[240px] sm:flex-1`}
                  >
                  ...
                  <a
                    href="#work"
                    className={`${buttonVariants({ variant: "secondary" })} w-full justify-center sm:min-w-[240px] sm:flex-1`}
                  >
                    View Our Work{" "}
                    <ArrowRight
                      aria-hidden="true"
              ...
              {services.map((s, i) => (
                ...
                >
                  <div className="surface-card group relative flex h-full flex-col overflow-hidden rounded-lg border border-border-subtle p-9 transition-all hover:border-border">
                    ...
                    <p className="flex-1 text-[0.95rem] leading-[1.7] text-text-muted">
                      {s.desc}
                    </p>
                  </div>
                </FadeUp>
            ...
            <FadeUp>
              <div className="surface-card-strong relative overflow-hidden rounded-xl border border-border-subtle p-12 max-md:p-8">
                ...
                <p className="mt-2 text-[0.92rem] text-text-dim">
                  Open-Source Web3 Foundation · Ethereum Ecosystem · Sep 2022 –
                  Jan 2026
                </p>
                <p className="mt-6 max-w-[680px] text-[1.05rem] leading-[1.8] text-text-muted">
                  As part of a long-term B2B contract with AKASHA Foundation, we
                  worked with a team of engineers on AKASHA Core, a composable
                  framework for building Web3 social products. The work included
                  frontend architecture, component systems, performance
                  optimizations, and engineering standards across a distributed
                  team.
                </p>
        ...
        <section
          id="process"
          className="scroll-mt-16 bg-bg-elevated px-8 pt-20 pb-14"
        ...
        >
          <div className="mx-auto max-w-[1200px]">
            ...
            <div className="relative xl:pt-4 xl:pb-8">
              <div className="pointer-events-none absolute inset-x-0 top-0 hidden h-[420px] xl:block">
                <svg
                  aria-hidden="true"
                ...
                >
                  <path
                    d="M194 206 C266 120, 338 120, 410 162"
                    fill="none"
                  ...
                  />
                  <path
                    d="M536 162 C610 112, 694 112, 768 162"
                    fill="none"
                    stroke="var(--color-accent)"
                    strokeWidth="2.5"
                    strokeLinecap="round"
                  ...
                  />
                  <path
                    d="M876 162 C950 120, 1026 120, 1102 206"
                    fill="none"
                    stroke="var(--color-accent)"
                    strokeWidth="2.5"
                    strokeLinecap="round"
                ...
                {processSteps.map((s, i) => (
                  <FadeUp key={s.num} delay={100 * (i + 1)}>
                    ...
                    >
                      ...
                      <h3 className="mt-5 text-[1.1rem] font-semibold">
                        {s.title}
                      </h3>
        ...
        <section
          id="about"
          className="scroll-mt-16 bg-bg-elevated px-8 pt-14 pb-20"
              ...
              <div className="grid grid-cols-1 gap-12 lg:grid-cols-[minmax(0,1.1fr)_minmax(320px,0.9fr)]">
                <div>
                  <p className="max-w-[54ch] text-[1.12rem] leading-[1.85] text-text">
                    Didd Tuni LLC is a Delaware-registered software engineering
                    consultancy led by Didd Tuni, a senior full stack engineer
                    with 15+ years of experience shipping production systems
                    across fintech, transportation, Web3, and enterprise SaaS.
                  </p>
                  <div className="mt-8 grid gap-3">
                    {[
                      ...
                      },
                      {
                        ...
                        body: "US, EU, and UAE-friendly delivery.",
                      },
                      {
              ...
              {testimonials.map((t, i) => (
                <FadeUp key={t.author} delay={100 * (i + 1)} className="h-full">
                  <div className="surface-card relative flex h-full flex-col rounded-lg border border-border-subtle p-8">
                    ...
                    <div className="mt-0.5 text-[0.8rem] text-text-dim">
                      {t.role}
                    </div>
                  </div>
                </FadeUp>
              ...
              <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
                <div>
                  ...
                  <p className="mt-6 text-base leading-[1.8] text-text-muted">
                    Whether you need a senior engineer embedded in your team, a
                    design system built from scratch, or architectural guidance
                    for a complex platform — we&apos;d love to hear about your
                    project.
                  </p>
                  <div className="mt-8 flex flex-col gap-4">
                    {[
                      {
                        label: "Email",
                        value: "contact@diddtunillc.com",
                        href: "mailto:contact@diddtunillc.com",
                      },
                      {
                        label: "Web",
                        value: "diddtunillc.com",
                        href: "https://diddtunillc.com",
                      },
                      {
                        label: "Address",
                        value: "16192 Coastal Highway\nLewes, DE 19958, US",
                      },
                    ].map((c) => (
